        ...
        <div style={{ padding: "0 1.5rem" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
            ...
            <Link href="/" style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
              <OculveLogo height={24} />
            </Link>

            {/* Center Nav — desktop only, only on public pages */}
            {!hideLinks && (
              <nav style={{ display: "flex", alignItems: "center", gap: "2rem" }} className="desktop-only">
                <Link href="/#features" className="link-subtle" style={{ fontSize: "0.75rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--foreground-muted)" }}>Features</Link>
                <Link href="/#pricing" className="link-subtle" style={{ fontSize: "0.75rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em", color: "var(--foreground-muted)" }}>Support Us</Link>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexShrink: 0 }}>
              ...
              <div className="desktop-only" style={{ display: "flex", alignItems: "center", gap: "0.75rem", minWidth: "140px", justifyContent: "flex-end" }}>
                ...
                <div style={{ display: "contents" }}>
                  {!mounted ? (
                    <div style={{ width: "100px", height: "32px", background: "var(--card-border)", borderRadius: "100px", opacity: 0.2 }} />
              ...
              <div className="mobile-only" style={{ display: "flex", alignItems: "center", gap: "0.75rem", minWidth: "54px", justifyContent: "flex-end" }}>
                ...
                <div className="auth-group-mobile" style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  {!mounted ? null : (
                    <>
                      {isAuthLoading && !isLoggedIn && (
            ...
            {!hideLinks && (
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <Link href="/#features" onClick={() => setMobileMenuOpen(false)} style={{ fontSize: "1rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>Features</Link>
                  <ThemeSwitcher />
                </div>
                <Link href="/#pricing" onClick={() => setMobileMenuOpen(false)} style={{ fontSize: "1rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>Support Us</Link>
